export default function PopUpAddMonitor({ setCode,setIsOpen, linkMonitorToUser }) {
    return (
        <div className="flex flex-col justify-center p-5 gap-3 mt-3">
            <button onClick={() => setIsOpen(false)} className="absolute top-1 right-1 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" >
